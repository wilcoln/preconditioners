...
def create_argparser():
    ...
    parser.add_argument('--sigma2_min', help='Minimum standard deviation of label noise', type=float, default=1)
    parser.add_argument('--sigma2_max', help='Minimum standard deviation of label noise', type=float, default=10)
    parser.add_argument('--sigma2_step', help='Minimum standard deviation of label noise', type=float, default=2)
    # Experiment params
